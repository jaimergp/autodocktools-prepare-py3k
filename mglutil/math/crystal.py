...
class Crystal:
    ...
    def __init__(self, length, angles):
        ...
        self.ftoc = self._uinv( numpy.transpose(self.ctof) ) # build ftoc
    ...
    def _uinv(self, mat):
        ...
        dmat = numpy.identity(3).astype('d')
        imat = numpy.identity(3).astype('d')
    ...
    def rotate(self, rot, coords):
        ...
        return numpy.dot(coords, numpy.transpose(rot)) 
