# $Header: /opt/cvs/python/packages/share1.5/mglutil/splashregister/about.py,v 1.10 2011/05/16 18:28:03 sargis Exp $
# $Id: about.py,v 1.10 2011/05/16 18:28:03 sargis Exp $
import tkinter, os
