...
########################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/mglutil/gui/BasicWidgets/Tk/trees/tree.py,v 1.57.2.1 2015/08/26 18:55:06 sanner Exp $
#
# $Id: tree.py,v 1.57.2.1 2015/08/26 18:55:06 sanner Exp $
#
...
"""
    ...
    def reallyRedraw(self, force=False):
        ...
        if not force:
            for node in list(prevDisplayNodes.keys()):
                #print 'destroying', node.object.name
                node.deleteNodeIcons()
...
below self"""
    ...
    def refresh(self):
        self.needsRedraw = True
        self.tree().canvas.itemconfig(self.labelTkid, text=str(self))
