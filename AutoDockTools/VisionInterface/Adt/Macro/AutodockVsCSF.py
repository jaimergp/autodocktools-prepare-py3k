...
class AutodockVsCSF(MacroNode):
    ...
    def afterAddingToNetwork(self):
        ...
        try:
            ...
            PrepareADVSInputs_3.addInputPort(*(), **{'singleConnection': True, 'name': 'ligands', 'cast': True, 'datatype': 'LigandDB', 'defaultValue': None, 'required': True, 'height': 8, 'width': 12, 'shape': 'rect', 'color': '#FFCCFF', 'originalDatatype': 'None'})
            PrepareADVSInputs_3.addInputPort(*(), **{'singleConnection': True, 'name': 'autogrid_results', 'cast': True, 'datatype': 'autogrid_results', 'defaultValue': None, 'required': True, 'height': 8, 'width': 12, 'shape': 'triangle', 'color': '#FF33CC', 'originalDatatype': 'None'})
            PrepareADVSInputs_3.addInputPort(*(), **{'singleConnection': True, 'name': 'dpf_template_obj', 'cast': True, 'datatype': 'dpf_template', 'defaultValue': None, 'required': True, 'height': 8, 'width': 12, 'shape': 'triangle', 'color': '#9933FF', 'originalDatatype': 'None'})
            PrepareADVSInputs_3.addOutputPort(*(), **{'name': 'filter_file', 'datatype': 'string', 'height': 8, 'width': 12, 'shape': 'oval', 'color': 'white'})
            PrepareADVSInputs_3.addOutputPort(*(), **{'name': 'ligand_lib', 'datatype': 'string', 'height': 8, 'width': 12, 'shape': 'oval', 'color': 'white'})
            PrepareADVSInputs_3.addOutputPort(*(), **{'name': 'dpf_template_file', 'datatype': 'string', 'height': 8, 'width': 12, 'shape': 'oval', 'color': 'white'})
            PrepareADVSInputs_3.addOutputPort(*(), **{'name': 'autogrid_res_url', 'datatype': 'string', 'height': 8, 'width': 12, 'shape': 'oval', 'color': 'white'})
            PrepareADVSInputs_3.addOutputPort(*(), **{'name': 'autogrid_res_local', 'datatype': 'string', 'height': 8, 'width': 12, 'shape': 'oval', 'color': 'white'})
...
"""
            ...
            PrepareADVSInputs_3.configure(*(), **{'paramPanelImmediate': 1, 'expanded': False})
        except:
        ...
        try:
            ...
            autodock_kryptonite_nbcr_net_4.inputPortByName['ga_run'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['lib'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['filter_file_url'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['ga_num_evals'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['filter_file'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['sched'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['urllib'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['ga_num_generations'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['dpf'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['u'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['utar'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['userlib'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['ga_pop_size'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['localRun'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['email'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['execPath'].configure(*(), **{'defaultValue': None})
            autodock_kryptonite_nbcr_net_4.inputPortByName['ga_run'].widget.set(r"", run=False)
            autodock_kryptonite_nbcr_net_4.inputPortByName['lib'].widget.configure(*(), **{'choices': ('sample', 'NCIDS_SC', 'NCI_DS1', 'NCI_DS2', 'human_metabolome', 'chembridge_building_blocks', 'drugbank_nutraceutics', 'drugbank_smallmol', 'fda_approved')})
            ...
            autodock_kryptonite_nbcr_net_4.inputPortByName['sched'].widget.configure(*(), **{'choices': ('SGE', 'CSF')})
            ...
            autodock_kryptonite_nbcr_net_4.configure(*(), **{'paramPanelImmediate': 1, 'expanded': False})
        except:
        ...
        try:
            ...
            GetMainURLFromList_5.inputPortByName['urls'].configure(*(), **{'defaultValue': None})
            GetMainURLFromList_5.configure(*(), **{'paramPanelImmediate': 1, 'expanded': False})
        except:
        ...
        try:
            ...
            GetMainURLFromList_7.inputPortByName['urls'].configure(*(), **{'defaultValue': None})
            GetMainURLFromList_7.configure(*(), **{'paramPanelImmediate': 1, 'expanded': False})
        except:
            print("WARNING: failed to restore GetMainURLFromListNode named GetMainURLFromList in network self.macroNetwork")
            print_exc()
        ...
        try:
            ...
            AutodockSlice_oolitevm_calit2_optiputer_net_8.inputPortByName['execPath'].configure(*(), **{'defaultValue': None})
            AutodockSlice_oolitevm_calit2_optiputer_net_8.inputPortByName['localRun'].configure(*(), **{'defaultValue': None})
            AutodockSlice_oolitevm_calit2_optiputer_net_8.inputPortByName['divisor'].configure(*(), **{'defaultValue': None})
            AutodockSlice_oolitevm_calit2_optiputer_net_8.inputPortByName['lib'].configure(*(), **{'defaultValue': None})
            AutodockSlice_oolitevm_calit2_optiputer_net_8.inputPortByName['input_url'].configure(*(), **{'defaultValue': None})
            ...
            AutodockSlice_oolitevm_calit2_optiputer_net_8.configure(*(), **{'paramPanelImmediate': 1, 'expanded': False})
        except:
