...
class recluster(MacroNode):
    ...
    def afterAddingToNetwork(self):
        ...
        try:
            ...
            Docking_16.addInputPort(*(), **{'name': 'docking_logs', 'cast': True, 'datatype': 'list', 'balloon': 'list of docking log files to be read into as a single Docking', 'height': 12, 'width': 12, 'shape': 'oval', 'color': 'cyan'})
            Docking_16.addInputPort(*(), **{'name': 'rmsTool', 'cast': True, 'datatype': 'None', 'balloon': 'rmsTool to be used for clustering', 'required': False, 'height': 8, 'width': 12, 'shape': 'diamond', 'color': 'white'})
            Docking_16.addOutputPort(*(), **{'name': 'docking', 'datatype': 'None', 'balloon': 'docking instance', 'height': 8, 'width': 12, 'shape': 'diamond', 'color': 'white'})
...
"""
        ...
        try:
            ...
            rmsTool_17.addInputPort(*(), **{'name': 'crds', 'cast': True, 'datatype': 'coordinates3D', 'balloon': 'coordinates to use as reference for rms calculation.', 'height': 8, 'width': 12, 'shape': 'rect', 'color': 'green'})
            rmsTool_17.addOutputPort(*(), **{'name': 'rmsTool', 'datatype': 'None', 'balloon': 'rmsTool created using crds as reference', 'height': 8, 'width': 12, 'shape': 'diamond', 'color': 'white'})
...
"""
        ...
        try:
            ...
            Read_Molecule_18.inputPortByName['filename'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Read_Molecule_18.outputPortByName['MolSets'].configure(*(), **{'color': '#c64e70', 'shape': 'oval'})
        ...
        try:
            ...
            Index_19.inputPortByName['data'].configure(*(), **{'datatype': 'MoleculeSet', 'cast': True, 'shape': 'oval', 'color': '#c64e70'})
            Index_19.inputPortByName['index'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            Index_19.outputPortByName['data'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
        except:
        ...
        try:
            ...
            Get_clusterer_21.inputPortByName['objects'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            Get_clusterer_21.inputPortByName['attr'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Get_clusterer_21.outputPortByName['attrs'].configure(*(), **{'color': 'cyan', 'shape': 'oval'})
            Get_clusterer_21.inputPortByName['attr'].widget.configure(*(), **{'choices': ('__doc__', '__init__', '__module__', 'addConformations', 'ch', 'clusterer', 'clusterer_dict', 'defaultParser', 'dlo_list', 'flex_res', 'ligMol', 'parser', 'readDlg', 'readEntropiaResults', 'readXMLResults', 'set_ligand', 'version', 'warnings', 'writeConformation', 'write_current_conformation')})
            Get_clusterer_21.inputPortByName['attr'].widget.set("clusterer", run=False)
            Get_clusterer_21.configure(*(), **{'expanded': True})
        except:
        ...
        try:
            ...
            Index_22.inputPortByName['data'].configure(*(), **{'datatype': 'list', 'cast': True, 'shape': 'oval', 'color': 'cyan'})
            Index_22.inputPortByName['index'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            Index_22.outputPortByName['data'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
        except:
            print("WARNING: failed to restore Index named Index in network self.macroNetwork")
            print_exc()
            Index_22=None
        ...
        try:
            ...
            make_clustering_23.addInputPort(*(), **{'name': 'clusterer', 'cast': True, 'datatype': 'None', 'balloon': 'clusterer which will make the new clustering', 'height': 8, 'width': 12, 'shape': 'diamond', 'color': 'white'})
            make_clustering_23.addInputPort(*(), **{'name': 'tolerance', 'cast': True, 'datatype': 'float', 'balloon': 'rms tolerance for the new clustering', 'height': 12, 'width': 12, 'shape': 'circle', 'color': 'green'})
            make_clustering_23.addOutputPort(*(), **{'name': 'clustering', 'datatype': 'None', 'balloon': 'clustering at newest rms', 'height': 8, 'width': 12, 'shape': 'diamond', 'color': 'white'})
...
"""
        ...
        try:
            ...
            Dial_24.inputPortByName['dial'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Dial_24.inputPortByName['mini'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Dial_24.inputPortByName['maxi'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Dial_24.outputPortByName['value'].configure(*(), **{'color': 'green', 'shape': 'circle'})
            Dial_24.inputPortByName['dial'].widget.set(3.0, run=False)
            Dial_24.configure(*(), **{'expanded': False})
        except:
