...
class PrepareAD3Ligand(MacroNode):
    ...
    def afterAddingToNetwork(self):
        ...
        try:
            ...
            Calculate_Gasteiger_Charges_3.inputPortByName['mols'].configure(*(), **{'color': '#c64e70', 'cast': True, 'shape': 'oval'})
            Calculate_Gasteiger_Charges_3.outputPortByName['mols'].configure(*(), **{'color': '#c64e70', 'shape': 'oval'})
            Calculate_Gasteiger_Charges_3.outputPortByName['charge_total'].configure(*(), **{'color': 'green', 'shape': 'circle'})
        except:
        ...
        try:
            ...
            Add_Hydrogens_4.inputPortByName['molecules'].configure(*(), **{'color': '#c64e70', 'cast': True, 'shape': 'oval'})
            Add_Hydrogens_4.outputPortByName['molecules'].configure(*(), **{'color': '#c64e70', 'shape': 'oval'})
            Add_Hydrogens_4.outputPortByName['new_h_ct'].configure(*(), **{'color': 'yellow', 'shape': 'circle'})
        except:
        ...
        try:
            ...
            Merge_NonPolar_Hydrogens_5.inputPortByName['mols'].configure(*(), **{'color': '#c64e70', 'cast': True, 'shape': 'oval'})
            Merge_NonPolar_Hydrogens_5.inputPortByName['renumber'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            Merge_NonPolar_Hydrogens_5.outputPortByName['mols'].configure(*(), **{'color': '#c64e70', 'shape': 'oval'})
            Merge_NonPolar_Hydrogens_5.outputPortByName['num_nphs'].configure(*(), **{'color': 'yellow', 'shape': 'circle'})
        except:
        ...
        try:
            ...
            Manage_Rotatable_Bonds_6.inputPortByName['mols'].configure(*(), **{'color': '#c64e70', 'cast': True, 'shape': 'oval'})
            Manage_Rotatable_Bonds_6.inputPortByName['root'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Manage_Rotatable_Bonds_6.inputPortByName['allowed_bonds'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Manage_Rotatable_Bonds_6.inputPortByName['check_for_fragments'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            Manage_Rotatable_Bonds_6.inputPortByName['bonds_to_inactivate'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Manage_Rotatable_Bonds_6.inputPortByName['limit_torsions'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Manage_Rotatable_Bonds_6.outputPortByName['mol'].configure(*(), **{'color': '#c64e70', 'shape': 'oval'})
        except:
        ...
        try:
            ...
            AD4_typer_7.inputPortByName['mols'].configure(*(), **{'color': '#c64e70', 'cast': True, 'shape': 'oval'})
            AD4_typer_7.inputPortByName['renameAtoms'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            AD4_typer_7.inputPortByName['set_aromatic_carbons'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            AD4_typer_7.inputPortByName['reassign'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            AD4_typer_7.outputPortByName['typed_mols'].configure(*(), **{'color': '#c64e70', 'shape': 'oval'})
        except:
