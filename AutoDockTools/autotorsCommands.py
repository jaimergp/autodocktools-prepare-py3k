...
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/autotorsCommands.py,v 1.122.2.2 2016/02/11 09:24:08 annao Exp $
#
...
versa"""
        ...
        for mol, atomSets in zip_longest(molecules, ats):
            if mol == self.vf.atorsDict['molecule']:
                atorsAtoms = atomSets
                break
        if not atorsAtoms:
