...
# $Header: /opt/cvs/python/packages/share1.5/MolKit/amberPrmTop.py,v 1.32.10.1 2016/02/12 01:12:48 annao Exp $
#
# $Id: amberPrmTop.py,v 1.32.10.1 2016/02/12 01:12:48 annao Exp $
#
...
##          raise RuntimError('dihedral type not in dictionary')
    ...
    def getICO(self, ntypes):
        ct = 1
        icoArray = numpy.zeros((ntypes, ntypes), 'i')
