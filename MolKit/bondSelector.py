...
#
# $Header: /opt/cvs/python/packages/share1.5/MolKit/bondSelector.py,v 1.26.2.1 2016/02/12 01:12:48 annao Exp $
#
# $Id: bondSelector.py,v 1.26.2.1 2016/02/12 01:12:48 annao Exp $
#
#
#
    ...
    def select(self, bnds, cutoff=7.5):
        ...
        for ring in rf.rings:
            ...
            for bnd in blist:
                ...
                pt2 = at2.coords
                pt3 = at3.coords
                a1 = numpy.subtract(pt2,pt1)
                b1 = numpy.subtract(pt3,pt2)
                p = [a1[1]*b1[2]-a1[2]*b1[1],a1[2]*b1[0]-a1[0]*b1[2],a1[0]*b1[1]-a1[1]*b1[0]]
                result0 = numpy.sqrt(p[0]*p[0]+p[1]*p[1]+p[2]*p[2])
                bnd.nrmsize = result0
                result1 = p
                bnd.nrms = result1
